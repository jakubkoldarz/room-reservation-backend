...
namespace RoomReservation.Core.Interfaces
{
    public interface IReservationService
    {
        ...
        Task<Result> ForceCancelAsync(Guid reservationId, string? reason, Guid? cancelledById = null);
        Task<Result> BulkForceCancelAsync(IReadOnlyList<Reservation> reservations, string? reason, Guid? cancelledById = null);
